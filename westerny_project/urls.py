...
urlpatterns = [
    ...
    path('add_article_genre/<int:genre_id>', AddArticleGenreView.as_view(), name="add-article-genre"),
    path('delete_article_genre/<int:genre_id>/<int:article_id>', DeleteArticleGenreView.as_view(), name="delete-article-genre"),
    path('add_article_person/<int:person_id>', AddArticlePersonView.as_view(), name="add-article-person"),
    ...
    path('add_article_movie/<int:movie_id>', AddArticleMovieView.as_view(), name="add-article-movie"),
